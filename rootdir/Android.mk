...
include $(CLEAR_VARS)
LOCAL_MODULE       := android.hardware.nfc@1.2-service.st.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/android.hardware.nfc@1.2-service.st.rc
...
# Corrigido para s97pro
include $(CLEAR_VARS)
LOCAL_MODULE       := init.s97pro.incall_fixup.rc
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := etc/init.s97pro.incall_fixup.rc
LOCAL_MODULE_PATH  := $(TARGET_OUT_VENDOR_ETC)/init/hw
include $(BUILD_PREBUILT)

include $(CLEAR_VARS)
LOCAL_MODULE       := init.s97pro.incall_fixup.sh
LOCAL_MODULE_TAGS  := optional
LOCAL_MODULE_CLASS := ETC
LOCAL_SRC_FILES    := bin/init.s97pro.incall_fixup.sh
...
include $(CLEAR_VARS)
LOCAL_MODULE       := vendor.ueventd.rc
