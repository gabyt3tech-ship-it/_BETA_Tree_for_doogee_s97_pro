package co.potatoproject.dt2w.s97pro;
...
public class DT2WServiceS97Pro extends Service {
    private static final String TAG = "DT2WServiceS97Pro";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.s97pro.dt2w", dt2wEnabled ? "1" : "0");
        }
